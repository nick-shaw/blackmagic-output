...
def overlay_image(image: npt.NDArray, tpat: Dict, bits: int, directory: str) -> None:
    ...
    try:
        ...
        print("Warning: imageio not available, skipping image overlay")
        return
...
def render_tpat(tpat_in: str) -> Tuple:
    ...
    # Check the T-PAT file against the schema if jsonschema is available.
    if HAS_JSONSCHEMA:
...
# ============================================================================
# Main Blackmagic output application
# ============================================================================
